-- Host removes a guest from the party, or transfers host role to another member.
...
GRANT EXECUTE ON FUNCTION public.party_host_remove_member(uuid, uuid, text, uuid)
